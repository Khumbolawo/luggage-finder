        ...
        <div class="mb-6 w-full">
            ...
            <form class="mx-auto" action="{{ route('search-ticket') }}" method="GET">
                ...
                <div class="relative">
                    ...
                    <button
                        type="submit"
                        class="absolute bottom-2.5 end-2.5 rounded-lg bg-zinc-700 px-4 py-2 text-sm font-medium text-white hover:bg-zinc-800 focus:outline-none focus:ring-4 focus:ring-zinc-300 dark:bg-zinc-600 dark:hover:bg-zinc-500 dark:focus:ring-zinc-800"
                    >
                        Search
                    </button>
                </div>
                ...
                <tbody>
                    @foreach ($tickets as $ticket)
                        <tr class="bg-white dark:bg-zinc-800">
                            ...
                            <td class="px-6 py-4">
                                <a class="dark:hover:text-zinc-50" href="{{ route('ticket-summary') }}">link</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
